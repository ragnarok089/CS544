...
public class ClientRequestUpdate {
	...
	public ClientRequestUpdate(MessageType op, short messagelength, byte reserved,
			String[] option, String[] senderUsername){
	...
	public String toString(){
		...
		.append("Sender's username is: ").append(SenderUsername);
		return sb.toString();
	}
}
